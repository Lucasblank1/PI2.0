...
<head>
    ...
    <title>Perfil - Caça aos fatos História</title>
        ...
        <div class="container mx-auto px-4">
            <?php if (isset($_GET['erro']) && $_GET['erro'] === 'exclusao'): ?>
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
                    <strong class="font-bold">Erro ao excluir conta!</strong>
                    <span class="block sm:inline">
                        <?php 
                        if (isset($_GET['mensagem'])) {
                            echo htmlspecialchars(urldecode($_GET['mensagem']));
                        } else {
                            echo "Ocorreu um erro ao tentar excluir sua conta. Por favor, tente novamente.";
                        }
                        ?>
                    </span>
                </div>
