...
<head>
    ...
    <title>Sobre - Caça aos fatos História</title>
...
<body class="min-h-screen hero-pattern">
    ...
    <div class="bg-amber-700 text-white py-12">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl font-bold mb-4">Sobre o Caça aos fatos História</h1>
            ...
            <div class="max-w-3xl mx-auto">
                <div class="bg-amber-100 rounded-xl p-8 shadow-lg mb-12">
                    ...
                    <p class="text-amber-700 mb-6">
                        O Caça aos fatos História nasceu com o objetivo de tornar o aprendizado da história do Brasil mais envolvente e acessível. 
