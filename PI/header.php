        ...
        <div class="flex justify-between items-center">
            ...
            <nav>
                <ul class="flex space-x-6">
                    ...
                    <li><a href="sobre.php" class="text-white hover:text-amber-200 transition-colors">Sobre</a></li>
                    <li><a href="index.php#footer" class="text-white hover:text-amber-200 transition-colors">Contato</a></li>
