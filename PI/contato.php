...
<head>
    ...
    <title>Contato - Caça aos fatos História</title>
                    ...
                    <div class="bg-amber-100 rounded-xl p-8 shadow-lg contact-card">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                ...
                                <a href="mailto:contato@cacaosfatos.com.br" class="text-amber-700 hover:text-amber-800">
                                    contato@cacaosfatos.com.br
                                </a>
                            </div>
                            <div class="flex items-center">
